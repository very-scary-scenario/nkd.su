...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RobotApocalypse'
        db.create_table('vote_robotapocalypse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('overridden_showdate', self.gf('django.db.models.fields.DateField')(unique=True)),
        ))
        db.send_create_signal('vote', ['RobotApocalypse'])


    def backwards(self, orm):
        # Deleting model 'RobotApocalypse'
        db.delete_table('vote_robotapocalypse')
