...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScheduleOverride'
        db.create_table('vote_scheduleoverride', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('overridden_showdate', self.gf('django.db.models.fields.DateField')()),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('finish', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('vote', ['ScheduleOverride'])


    def backwards(self, orm):
        # Deleting model 'ScheduleOverride'
        db.delete_table('vote_scheduleoverride')
    ...
    models = {
        ...
        'vote.scheduleoverride': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'overridden_showdate': ('django.db.models.fields.DateField', [], {}),
