...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Play.tweet_id'
        db.alter_column('vote_play', 'tweet_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Play.tweet_id'
        db.alter_column('vote_play', 'tweet_id', self.gf('django.db.models.fields.IntegerField')(default=0))

    models = {
        'vote.abuser': {
            'Meta': {'object_name': 'Abuser'},
