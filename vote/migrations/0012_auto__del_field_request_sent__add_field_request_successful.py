...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request.sent'
        db.delete_column('vote_request', 'sent')

        # Adding field 'Request.successful'
        db.add_column('vote_request', 'successful',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Request.sent'
        db.add_column('vote_request', 'sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Request.successful'
        db.delete_column('vote_request', 'successful')
