...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.track'
        db.alter_column('vote_vote', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vote.Track'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Vote.track'
        raise RuntimeError("Cannot reverse this migration. 'Vote.track' and its values cannot be restored.")
