...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Play.show'
        db.alter_column(u'vote_play', 'show_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['vote.Show']))

    def backwards(self, orm):

        # Changing field 'Vote.show'
        db.alter_column(u'vote_vote', 'show_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vote.Show']))

        # Changing field 'Play.show'
        db.alter_column(u'vote_play', 'show_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vote.Show'], null=True))
    ...
    models = {
        ...
        u'vote.vote': {
            ...
            'show': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': u"orm['vote.Show']"}),
