...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterUser.user_image'
        db.delete_column(u'vote_twitteruser', 'user_image')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TwitterUser.user_image'
        raise RuntimeError("Cannot reverse this migration. 'TwitterUser.user_image' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TwitterUser.user_image'
        db.add_column(u'vote_twitteruser', 'user_image',
