...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.composer'
        db.add_column(u'vote_track', 'composer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Track.label'
        db.add_column(u'vote_track', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.composer'
        db.delete_column(u'vote_track', 'composer')

        # Deleting field 'Track.label'
        db.delete_column(u'vote_track', 'label')
