...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'vote_twitteruser', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'TwitterUser.name'
        db.alter_column(u'vote_twitteruser', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
