...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.track'
        db.add_column(u'vote_request', 'track',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vote.Track'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.track'
        db.delete_column(u'vote_request', 'track_id')
    ...
    models = {
        ...
        u'vote.request': {
            ...
            'track': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vote.Track']", 'null': 'True', 'blank': 'True'})
        },
        u'vote.shortlist': {
        ...
        u'vote.twitteruser': {
            ...
            'is_patron': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
