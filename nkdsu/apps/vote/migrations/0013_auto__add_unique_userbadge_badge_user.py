...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserBadge', fields ['badge', 'user']
        db.create_unique(u'vote_userbadge', ['badge', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserBadge', fields ['badge', 'user']
        db.delete_unique(u'vote_userbadge', ['badge', 'user_id'])
