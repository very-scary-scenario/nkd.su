...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.voting_allowed'
        db.add_column(u'vote_show', 'voting_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        if not db.dry_run:
            orm.Show.objects.all().update(voting_allowed=True)


    def backwards(self, orm):
        # Deleting field 'Show.voting_allowed'
        db.delete_column(u'vote_show', 'voting_allowed')
