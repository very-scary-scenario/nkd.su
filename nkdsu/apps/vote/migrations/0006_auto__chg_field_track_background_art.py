...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.background_art'
        db.alter_column(u'vote_track', 'background_art', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'Track.background_art'
        db.alter_column(u'vote_track', 'background_art', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
