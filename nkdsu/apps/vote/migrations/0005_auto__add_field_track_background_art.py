...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.background_art'
        db.add_column(u'vote_track', 'background_art',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.background_art'
        db.delete_column(u'vote_track', 'background_art')
    ...
    models = {
        ...
        u'vote.track': {
            ...
            'background_art': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
