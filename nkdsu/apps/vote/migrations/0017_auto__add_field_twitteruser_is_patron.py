...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterUser.is_patron'
        db.add_column(u'vote_twitteruser', 'is_patron',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterUser.is_patron'
        db.delete_column(u'vote_twitteruser', 'is_patron')
