...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vote_userbadge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('badge', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vote.TwitterUser'])),
        ))
        db.send_create_signal(u'vote', ['UserBadge'])


    def backwards(self, orm):
        # Deleting model 'UserBadge'
        db.delete_table(u'vote_userbadge')
