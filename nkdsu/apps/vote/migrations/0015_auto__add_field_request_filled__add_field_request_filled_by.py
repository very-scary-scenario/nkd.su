...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.filled'
        db.add_column(u'vote_request', 'filled',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.filled_by'
        db.add_column(u'vote_request', 'filled_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.filled'
        db.delete_column(u'vote_request', 'filled')

        # Deleting field 'Request.filled_by'
        db.delete_column(u'vote_request', 'filled_by_id')
