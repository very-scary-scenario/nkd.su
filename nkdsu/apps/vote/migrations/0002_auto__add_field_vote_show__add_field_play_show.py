...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.show'
        db.add_column(u'vote_vote', 'show',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='votes', null=True, to=orm['vote.Show']),
                      keep_default=False)

        # Adding field 'Play.show'
        db.add_column(u'vote_play', 'show',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vote.Show'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.show'
        db.delete_column(u'vote_vote', 'show_id')

        # Deleting field 'Play.show'
        db.delete_column(u'vote_play', 'show_id')
    ...
    models = {
        ...
        u'vote.vote': {
            ...
            'show': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'votes'", 'null': 'True', 'to': u"orm['vote.Show']"}),
